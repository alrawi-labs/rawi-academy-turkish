...
type PgData = Pick<DifferenceTowWordsData, "word1" | "meaning1" | "explain1" | "example1" | "answer1">;

export default function DifferenceTowWordsMeaning1({ data }: TemplateProps<PgData>) {
  const { word1, meaning1, explain1, example1, answer1 } = data;
